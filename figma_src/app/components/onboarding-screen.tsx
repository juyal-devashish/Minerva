...
export function OnboardingScreen({ onComplete }: OnboardingScreenProps) {
  ...
  const steps = [
    {
      ...
      subtitle: 'Minerva highlights key terms and entities in news articles, making complex stories easy to understand.',
      illustration: '📰'
    },
    {
      icon: Hand,
      title: 'Tap to understand',
      subtitle: 'Simply tap any highlighted term to get instant AI-generated context. Like having a smart assistant while you read.',
      illustration: '👆'
    },
    {
      icon: Grid3x3,
      title: 'Choose your interests',
      subtitle: 'Select topics you care about to personalize your news feed.',
      illustration: null
    }
  ];
  ...
  const handleNext = () => {
    if (currentStep < steps.length - 1) {
      ...
      onComplete(selectedCategories.length > 0 ? selectedCategories : ['All']);
    }
  };
